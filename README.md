...
방법: Elo rating에 기반한 방법, https://fivethirtyeight.com/features/formula-one-racing/ 에서 F1 레이싱에 적용한 방법과 비슷한 방법을 사용함. 한 트랙이 끝나면 1위는 7승 0패, 2위는 6승 1패, ..., 8위는 0승 7패를 한 것으로 계산하여 점수를 한번에 업데이트. 한번에 변할 수 있는 점수의 양을 제어하는 파라미터 "K"가 있는데, 여기서는 50점제 1-3번째 경기인 선수는 10, 4-5번째 경기인 선수는 7, 6번째 이상인 선수는 5를 사용함. 
...
그가 보여준 최고의 모습인 지난 시즌 승자전과 그가 보여준 최악의 모습인 이번 시즌 16강 2경기에서 관심받고 싶어하는 모습을 빼고, 그가 상대적으로 관심을 덜 받았던 시즌 1 32강, 16강 1회전, 이번 시즌 32강을 생각하면 된다. 더 높은 곳으로 올라가기 위해서는 관심도 좋지만 내실을 다질 필요가 있다.
